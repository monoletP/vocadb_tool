...
class SongListFormatter:
    def __init__(self, html_content: str):
        """
        HTML 콘텐츠에서 곡 목록을 추출하고 포맷팅하는 클래스입니다.
        
        Args:
            html_content: VocaDB 페이지의 HTML 내용
        """
        self.api = VocaDBAPI()
        self.song_ids = self._extract_song_ids(html_content)
        
    def _extract_song_ids(self, html_content: str) -> List[int]:
        """
        HTML에서 곡 ID를 추출합니다.
        """
